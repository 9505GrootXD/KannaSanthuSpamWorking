...
ABUSE_SPAM = [
    ...
    "గాలి ముండా ఇది", 
    "ఎం ర లంజ కొడకా Ni amma nu vere vadiki dhagara pampyav antaga",
