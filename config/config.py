...
ABUSE_SPAM = [
 ...
    "𝗡𝗶 𝗮𝗺𝗺𝗮 𝗻𝘂 𝗳𝘂𝗸𝗶 𝗴𝗮𝗱𝗶 𝗺𝗮𝗱𝗱𝗮 𝗸𝗶𝗻𝗱𝗮 𝗽𝗮𝗻𝗱𝗮𝗯𝗲𝘁𝘁𝘂",  
 ...
    "𝗡𝗶 𝗮𝗺𝗺𝗮 𝗯𝗼𝗿𝘂 𝗯𝗮𝗮𝘃𝗶 𝗮𝗱𝗲 𝗻𝗮 𝘀𝘁𝗵𝗮𝗻𝗮𝗹𝗮 𝗯𝗮𝘃𝗶",  
 ...
    "𝗡𝙞 𝙖𝙢𝙢𝙖 𝙥𝙪𝙠𝙪 𝙣𝙞 𝙙𝙚𝙣𝙜𝙞𝙩𝙚 𝙜𝙪𝙙𝙙𝙝𝙖 𝙜𝙤𝙧𝙞𝙣𝙩𝙖𝙠𝙪𝙡𝙖 𝙥𝙖𝙣𝙙𝙖𝙡𝙞",  
    "𝗡𝙞 𝙖𝙢𝙢𝙖 𝙠𝙤𝙟𝙟𝙖 𝙡𝙖𝙣𝙟𝙖",  
    "𝘕𝘰𝘵𝘭𝘰 𝘮𝘢𝘥𝘥𝘢 𝘱𝘦𝘵𝘵𝘪 𝘋𝘦𝘯𝘨𝘪𝘵𝘦 𝘱𝘪𝘵𝘩𝘪 𝘨𝘶𝘥𝘥𝘩𝘢𝘭 𝘯𝘶𝘯𝘤𝘩𝘪 𝘷𝘦𝘳𝘺𝘢 𝘬𝘢𝘯𝘢𝘭𝘶 𝘷𝘢𝘴𝘵𝘩𝘢𝘪",  
 ...
    "𝗡𝐢 𝐚𝐦𝐦𝐚 𝐫𝐞𝐝 𝐩𝐮𝐤𝐮 👅",  
    "𝗡𝐢 𝐚𝐦𝐦𝐚 𝐠𝐫𝐞𝐞𝐧 𝐩𝐮𝐤𝐮 👅",  
    "𝗡𝐢 𝐩𝐞𝐥𝐥𝐚𝐦 𝐨𝐫𝐚𝐧𝐠𝐞 𝐩𝐮𝐤𝐮 👅",  
    "𝗡𝐢 𝐚𝐦𝐦𝐚 𝐠𝐮𝐝𝐝𝐡𝐚 𝐥𝐚 𝐚𝐝𝐢𝐭𝐲𝐚 𝐠𝐚𝐝𝐢 𝐦𝐚𝐝𝐝𝐚",  
    "𝗡𝐢 𝐩𝐞𝐥𝐥𝐚𝐦 𝐩𝐮𝐤𝐮 𝐤𝐚𝐬𝐢 𝐩𝐮𝐤𝐮 👅",  
    "𝑵𝒊 𝒂𝒎𝒎𝒂 𝒑𝒖𝒌𝒖𝒍𝒐 𝑏𝑙𝑎𝑐𝑘 𝑐𝑎𝑡 𝑡𝑒𝑎𝑚 𝒎𝒐𝒅𝒅𝒂",  
    "𝗡𝗶 𝗮𝗺𝗺𝗮 𝗽𝘂𝗸𝘂𝗹𝗼 𝘇𝗮𝗶𝗱 𝗴𝗮𝗱𝗶 𝗺𝗮𝗱𝗱𝗮",  
    "𝗡𝗶 𝗮𝗺𝗺𝗮 𝗽𝘂𝗸𝘂 𝗹𝗼 𝗸𝗮 𝗽𝗮𝘂𝗹 𝗺𝗮𝗱𝗱𝗮",  
    "𝗡𝗶 𝗮𝗺𝗺𝗮 𝗽𝘂𝗸𝘂𝗹𝗼 𝗮𝗹𝗶𝗲𝗻𝘀 𝗺𝗮𝗱𝗱𝗮",  
    "𝗡𝗶 𝗮𝗺𝗺𝗮 𝗴𝘂𝗱𝗵𝗮 𝗸𝗮𝗺𝗺𝗮𝗻𝗶 𝗺𝘂𝗱𝗱𝗵𝗮",  
    "𝗡𝗶 𝗮𝗺𝗺𝗮 𝗽𝘂𝗸𝘂𝗹𝗼 𝗴𝗿𝗼𝗼𝘁 𝗴𝗮𝗱𝗶 𝗺𝗼𝗱𝗱𝗮",  
    "𝗡𝗶 𝗮𝗺𝗺𝗮 𝗻𝘂 𝗯𝗰𝘁 𝗳𝗼𝘂𝗻𝗱𝗲𝗿 𝗴𝗮𝗱𝘂 𝗱𝗲𝗻𝗴𝗮",  
    "ని అక్క ను దేంగా",  
 ...
    "𝐑𝐞𝐲 𝐤𝐨𝐣𝐣𝐚 𝐝𝐡𝐚𝐦𝐮𝐧𝐭𝐲 𝐧𝐢 𝐩𝐢𝐜 𝐩𝐞𝐭𝐭𝐚𝐫𝐚 𝐧𝐞𝐧𝐮 𝐜𝐡𝐞𝐩𝐢𝐧𝐝𝐢 𝐧𝐢𝐣𝐚𝐦𝐨𝐤𝐚𝐝𝐡𝐨 𝐭𝐞𝐥𝐮𝐬𝐭𝐡𝐚𝐝𝐢 😂",  
    "𝐒𝐚𝐦𝐞 𝐤𝐨𝐣𝐣𝐚 𝐥𝐚 𝐮𝐧𝐧𝐚𝐝𝐮 😂 𝐧𝐚𝐚𝐯𝐮 𝐚𝐠𝐚𝐭𝐞𝐝𝐡𝐮 𝐫𝐚 𝐬𝐚𝐚𝐦𝐢 😂",  
    "𝐕𝗶𝗱𝗶 𝗳𝗮𝗰𝗲 𝗸𝗮𝗻𝘁𝘆 𝗻𝗮 𝗺𝗮𝗱𝗱𝗮 𝗯𝗮𝗴𝘂𝗻𝘁𝗵𝘂𝗻𝗱𝗶 😂",  
    "𝐍𝗮 𝗺𝗮𝗱𝗱𝗮 𝗰𝗵𝗶𝗸𝗮𝗿𝗮 𝗽𝘂𝗻𝘆𝗮𝗺 𝘃𝗮𝘀𝘁𝗵𝗱𝗶",  
    "𝐆𝐚𝐣𝐣𝐢 𝐝𝐚𝐧𝐚",  
 ...
    "𝗡𝗶 𝗮𝗺𝗺𝗮 𝗴𝘂𝗱𝗱𝗵𝗮𝗹𝗮 𝗱𝗮𝗿𝗸 𝗹𝗶𝗴𝗵𝘁 𝘃𝗮𝗹𝗹𝗮 𝘀𝘂𝗹𝗹𝗶",       "𝗻𝗶 𝗮𝗺𝗺𝗮 𝗽𝘂𝗸𝘂 𝗻𝗶 10000 𝗺𝗮𝗻𝗱𝗶 𝗱𝗲𝗻𝗴𝗶𝘁𝗲 𝗽𝘂𝘁𝘆𝗮𝘃 𝗻𝘂𝘃𝘂",  
 ...
    "𝗡𝗶 𝗴𝘂𝗱𝗵𝗹𝗮𝗮 𝗼𝗶𝗹 𝗽𝗼𝘀𝗲 𝗱𝗲𝗻𝗴𝗮",  
    "𝐀𝗿𝗲𝘆 𝗮𝗽𝗽𝘂𝗱𝘂 𝘀𝗿𝘂𝗷𝗮𝗻𝗮 𝗰𝗮𝗹𝗹 𝗿𝗲𝗰𝗼𝗿𝗱 𝘃𝗮𝗰𝗵𝗶𝗻𝗱𝗵𝗶 𝗰𝗵𝘂𝗱𝘂 𝗮𝗱𝗵𝗶 𝗻𝗶 𝗮𝗸𝗸𝗮 𝗱𝗵𝗶 𝗮𝗻𝗮𝘁𝘁𝗮 𝗴𝗮 𝗸𝗮𝗻𝗶 𝗱𝗮𝗻𝗶 𝗽𝘂𝗸𝘂 𝗰𝗵𝘂𝘀𝗮 𝗮 𝗹𝗲𝗮𝗸𝘀 𝗹𝗼𝗼 𝗻𝗶 𝗮𝗸𝗸𝗮 𝗽𝘂𝗸𝘂 𝗰𝗵𝘂𝘀𝗵𝗮",   
